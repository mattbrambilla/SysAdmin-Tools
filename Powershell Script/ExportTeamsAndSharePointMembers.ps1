# This script connects to Azure AD, Microsoft Teams, and SharePoint Online to export team membership information
# for a specified domain and a list of example users. It retrieves the teams and their members, filtering by the specified users,
